...
MEDIA_URL = '/media/'  # Para las imagenes
...
SECRET_KEY = 'django-insecure-_tf=gm(j6=a@h$!zpl--_4%wno_23xdw^@sdl^i_p2+$t9(pcd'
...
INSTALLED_APPS = [
    ...
    'rest_framework_simplejwt.token_blacklist',  # ← nuevo (logout)
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME':   timedelta(days=7),    # refresh: 7 días
